...
The Smith normal form of a matrix here refers to the decomposition of an integer matrix _D = PMQ_, where _D_, _P_, and _Q_ are integer matrices and _D_ is diagonal. This is somewhat like a singular value decomposition for integer matrices.
